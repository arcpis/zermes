...
- The production manager provider
  (:class:`zermes.tools.mcp_oauth_manager.HermesMCPOAuthProvider`) restoring metadata
...
from zermes.tools.mcp_oauth import HermesTokenStorage
...
class TestManagerOAuthProviderMetadata:
    ...
    def test_async_auth_flow_persists_on_completion(self, tmp_path, monkeypatch):
        ...
        ), patch("zermes.tools.mcp_oauth_manager.get_manager", return_value=manager):
            async def drive():
