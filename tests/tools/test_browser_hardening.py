...
class TestCommandTimeoutCache:
    ...
    def test_default_is_30(self):
        from zermes.tools.browser_tool import _get_command_timeout
...
class TestHomebrewNodeDirsCache:
    ...
    def test_lru_cached(self):
        from zermes.tools.browser_tool import _discover_homebrew_node_dirs
...
class TestTruncateSnapshot:
    ...
    def test_short_snapshot_unchanged(self):
        from zermes.tools.browser_tool import _truncate_snapshot
