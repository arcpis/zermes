"""Tests for zermes.tools.env_passthrough — skill and config env var passthrough."""
...
from zermes.tools.env_passthrough import (
...
class TestTerminalIntegration:
    ...
    def test_blocklisted_var_blocked_by_default(self):
        from zermes.tools.environments.local import _sanitize_subprocess_env, _HERMES_PROVIDER_ENV_BLOCKLIST
