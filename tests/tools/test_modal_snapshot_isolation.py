...
def _install_modal_test_modules(
    ...
    *,
    ...
    sys.modules["zermes.tools.environments.base"] = types.SimpleNamespace(
    ...
    sys.modules["zermes.tools.interrupt"] = types.SimpleNamespace(is_interrupted=lambda: False)
...
def test_modal_environment_migrates_legacy_snapshot_key_and_uses_snapshot_id(tmp_path):
    ...
    modal_module = _load_module("zermes.tools.environments.modal", TOOLS_DIR / "environments" / "modal.py")
