...
class TestGetTokensReconstructsExpiresIn:
    ...
    def test_get_tokens_returns_zero_ttl_for_expired_token(
        ...
        monkeypatch.setenv("HERMES_HOME", str(tmp_path))
        from zermes.tools.mcp_oauth import HermesTokenStorage, _get_token_dir
...
async def test_initialize_seeds_token_expiry_time_from_stored_tokens(
    ...
    from zermes.tools.mcp_oauth import HermesTokenStorage
    from zermes.tools.mcp_oauth_manager import _HERMES_PROVIDER_CLS, reset_manager_for_tests
