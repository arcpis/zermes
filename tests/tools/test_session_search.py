...
from zermes.tools.session_search_tool import (
    _format_timestamp,
...
class TestSessionSearchConcurrency:
    ...
    def test_session_search_respects_configured_concurrency_limit(self, monkeypatch):
        ...
        from zermes.tools.session_search_tool import session_search
        ...
        monkeypatch.setattr("zermes.tools.session_search_tool._summarize_session", fake_summarize)
        monkeypatch.setattr("zermes.model_tools._run_async", lambda coro: asyncio.run(coro))
...
class TestSessionSearch:
    ...
    def test_current_session_excluded_keeps_others(self):
        ...
        with _patch("zermes.tools.session_search_tool.async_call_llm",
    ...
    def test_source_from_resolved_parent_not_fts5_child(self):
        ...
        with _patch(
            "zermes.tools.session_search_tool.async_call_llm",
            new_callable=AsyncMock,
            side_effect=RuntimeError("no provider"),
        ):
