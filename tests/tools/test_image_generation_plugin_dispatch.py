...
class TestPluginDispatch:
    def test_dispatch_routes_to_codex_provider(self, monkeypatch, tmp_path):
        from zermes.tools import image_generation_tool
        from zermes.agent import image_gen_registry as registry_module
        from zermes.hermes_cli import plugins as plugins_module
