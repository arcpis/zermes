...
@pytest.fixture
def image_tool():
    """Fresh import of zermes.tools.image_generation_tool per test."""
    import importlib
    import zermes.tools.image_generation_tool as mod
...
class TestManagedGatewayErrorTranslation:
    ...
    def test_4xx_translates_to_value_error_with_remediation(self, image_tool, monkeypatch):
        """403 from managed gateway → ValueError mentioning FAL_KEY + hermes zermes.tools."""
        from unittest.mock import MagicMock

        # Simulate: managed mode active, managed submit raises 4xx.
        managed_gateway = MagicMock()
        managed_gateway.gateway_origin = "https://fal-queue-zermes.gateway.example.com"
