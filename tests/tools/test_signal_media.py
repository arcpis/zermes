...
class TestSendSignalMediaFiles:
    ...
    def test_send_signal_basic_text_without_media(self):
        ...
        from zermes.tools.send_message_tool import _send_signal
...
class TestSendSignalMediaRestrictions:
    ...
    def test_signal_allows_text_only_media_via_send_to_platform(self):
        ...
        with patch("zermes.tools.send_message_tool._send_signal", new=AsyncMock(return_value=mock_result)):
            config = MagicMock()
...
class TestSendSignalMediaWarningMessages:
    ...
    def test_warning_includes_signal_when_media_omitted(self):
        ...
        with patch("zermes.tools.send_message_tool._send_slack", new=AsyncMock(return_value={"success": True})):
            result = asyncio.run(
                _send_to_platform(
                    Platform.SLACK,
                    config,
