...
from zermes.tools.environments import modal as modal_env
from zermes.tools.environments import daytona as daytona_env
...
class TestBulkDownloadWiring:
    ...
    def test_modal_passes_bulk_download_fn(self, monkeypatch):
        ...
        from zermes.tools.environments.file_sync import iter_sync_files
