...
class TestAgentCloseMethod:
    ...
    def test_close_calls_cleanup_functions(self):
        ...
        with patch("zermes.run_agent.AIAgent.__init__", return_value=None):
            ...
            with patch("zermes.tools.process_registry.process_registry") as mock_registry,\
                 patch("zermes.run_agent.cleanup_vm") as mock_cleanup_vm,\
                 patch("zermes.run_agent.cleanup_browser") as mock_cleanup_browser:
                agent.close()
    ...
    def test_close_survives_partial_failures(self):
        ...
        with patch("zermes.run_agent.AIAgent.__init__", return_value=None):
            ...
            with patch(
                "zermes.tools.process_registry.process_registry"
            ) as mock_reg, patch(
                "zermes.run_agent.cleanup_vm"
            ) as mock_vm, patch(
                "zermes.run_agent.cleanup_browser"
            ) as mock_browser:
