...
from zermes.run_agent import AIAgent, IterationBudget
from zermes.tools.interrupt import set_interrupt, is_interrupted
...
def main() -> int:
    ...
    def agent_thread_func():
        ...
        with patch("zermes.run_agent.OpenAI") as MockOpenAI:
