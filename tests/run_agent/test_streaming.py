...
class TestStreamingAccumulator:
    ...
    @patch("zermes.run_agent.AIAgent._create_request_openai_client")
    @patch("zermes.run_agent.AIAgent._close_request_openai_client")
...
class TestPartialToolCallWarning:
    ...
    text was already delivered, the partial-stream stub at zermes.run_agent.py
...
class TestSilentRetryMidToolCall:
    ...
    @patch("zermes.run_agent.AIAgent._replace_primary_openai_client")
    @patch("zermes.run_agent.AIAgent._create_request_openai_client")
    @patch("zermes.run_agent.AIAgent._close_request_openai_client")
...
class TestCopilotACPStreamingDecision:
    ...
    @patch("zermes.agent.copilot_acp_client.CopilotACPClient")
