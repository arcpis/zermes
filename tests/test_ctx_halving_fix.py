...
class TestParseAvailableOutputTokens:
    ...
    def _parse(self, msg):
        from zermes.agent.model_metadata import parse_available_output_tokens_from_error
...
class TestContextNotHalvedOnOutputCapError:
    ...
    def test_output_cap_error_sets_ephemeral_not_context_length(self):
        ...
        from zermes.agent.model_metadata import parse_available_output_tokens_from_error
        from zermes.agent.model_metadata import get_next_probe_tier
        ...
        # Simulate the handler logic from zermes.run_agent.py
