"""Tests for the kanban CLI surface (zermes.hermes_cli.kanban)."""
...
from zermes.hermes_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from zermes.hermes_cli.commands import COMMANDS, SUBCOMMANDS
