...
from zermes.acp_adapter.tools import build_tool_start
...
class TestMcpRegistrationE2E:
    ...
    async def test_session_with_mcp_servers_registers_tools(self, acp_agent, mock_manager):
        ...
        with patch("zermes.tools.mcp_tool.register_mcp_servers", side_effect=mock_register),\
             patch("zermes.model_tools.get_tool_definitions", return_value=fake_tools):
