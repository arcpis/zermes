"""Tests for zermes.acp_adapter.auth — provider detection."""

from zermes.acp_adapter.auth import has_provider, detect_provider
...
class TestHasProvider:
    ...
    def test_has_no_provider_when_runtime_resolution_fails(self, monkeypatch):
        ...
        monkeypatch.setattr("zermes.hermes_cli.runtime_provider.resolve_runtime_provider", _boom)
        assert has_provider() is False
