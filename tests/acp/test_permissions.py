"""Tests for zermes.acp_adapter.permissions — ACP approval bridging."""
...
def _setup_callback(outcome, timeout=60.0):
    ...
    with patch("zermes.acp_adapter.permissions.asyncio.run_coroutine_threadsafe", return_value=future):
