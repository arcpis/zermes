...
class TestSaveConfigValueAtomic:
    ...
    def config_env(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("zermes.cli._hermes_home", hermes_home)
        return config_path
    ...
    def test_calls_atomic_yaml_write(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("zermes.utils.atomic_yaml_write", mock_atomic)
    ...
    def test_preserves_existing_keys(self, config_env):
        ...
        from zermes.cli import save_config_value
        save_config_value("zermes.agent.max_turns", 50)
    ...
    def test_file_not_truncated_on_error(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("zermes.utils.atomic_yaml_write", exploding_write)
