...
class TestRunConversationSurrogateSanitization:
    ...
    @patch("zermes.run_agent.AIAgent._build_system_prompt")
    @patch("zermes.run_agent.AIAgent._interruptible_streaming_api_call")
    @patch("zermes.run_agent.AIAgent._interruptible_api_call")
