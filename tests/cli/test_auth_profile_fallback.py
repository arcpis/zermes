...
def test_classic_mode_does_not_double_read_same_file(tmp_path, monkeypatch):
    ...
    from zermes.hermes_cli.auth import read_credential_pool, _global_auth_file_path
...
def test_write_credential_pool_targets_profile_not_global(profile_env):
    from zermes.hermes_cli.auth import read_credential_pool, write_credential_pool
