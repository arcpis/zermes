"""Tests for zermes.hermes_cli.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_hermes_home):
        ...
        import zermes.hermes_state as hermes_state
    ...
    def test_get_status_filters_unconfigured_gateway_platforms(self, monkeypatch):
        import zermes.gateway.config as gateway_config
        import zermes.hermes_cli.web_server as web_server
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from zermes.hermes_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_no_token(self, tmp_path):
        ...
        from starlette.testclient import TestClient
        from zermes.hermes_cli.web_server import app
        from zermes.hermes_cli.config import save_env_value
    ...
    def test_reveal_env_var_bad_token(self, tmp_path):
        ...
        from zermes.hermes_cli.config import save_env_value
        from zermes.hermes_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from zermes.hermes_cli.config import save_env_value
        from zermes.hermes_cli.web_server import _SESSION_TOKEN
...
class TestBuildSchemaFromConfig:
    def test_produces_expected_field_count(self):
        from zermes.hermes_cli.web_server import CONFIG_SCHEMA
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from zermes.hermes_cli.web_server import _build_schema_from_config
    ...
    def test_nested_keys_get_parent_category(self):
        ...
        from zermes.hermes_cli.web_server import CONFIG_SCHEMA
        if "zermes.agent.max_turns" in CONFIG_SCHEMA:
            assert CONFIG_SCHEMA["zermes.agent.max_turns"]["category"] == "agent"
...
class TestNewEndpoints:
    ...
    def test_profiles_list_falls_back_when_profile_listing_fails(self, monkeypatch):
        from zermes.hermes_constants import get_hermes_home
        import zermes.hermes_cli.profiles as profiles_mod
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        import zermes.tools.skills_tool as skills_tool
        import zermes.hermes_cli.skills_config as skills_config
        import zermes.hermes_cli.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        ...
        import zermes.toolsets as toolsets_module
        import zermes.hermes_cli.web_server as web_server
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from zermes.hermes_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from zermes.hermes_cli.web_server import _denormalize_config_from_web
...
class TestModelInfoEndpoint:
    ...
    def test_model_info_with_dict_config(self, monkeypatch):
        import zermes.hermes_cli.web_server as ws
        ...
        with patch("zermes.agent.model_metadata.get_model_context_length", return_value=200000):
            resp = self.client.get("/api/model/info")
    ...
    def test_model_info_capabilities(self, monkeypatch):
        ...
        with patch("zermes.agent.model_metadata.get_model_context_length", return_value=200000), \
             patch("zermes.agent.models_dev.get_model_capabilities", return_value=mock_caps):
            resp = self.client.get("/api/model/info")
    ...
    def test_model_info_graceful_on_metadata_error(self, monkeypatch):
        ...
        with patch("zermes.agent.model_metadata.get_model_context_length", side_effect=Exception("boom")):
            resp = self.client.get("/api/model/info")
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from zermes.hermes_cli.web_server import _normalise_theme_definition
...
class TestDiscoverUserThemes:
    ...
    def test_returns_empty_when_dir_missing(self, tmp_path, monkeypatch):
        ...
        from zermes.hermes_cli import web_server
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from zermes.hermes_cli.pty_bridge import PtyUnavailableError
        ...
        import zermes.hermes_cli.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self, monkeypatch):
        ...
        import time
        from urllib.parse import urlencode
        from zermes.hermes_cli import web_server as ws_mod
