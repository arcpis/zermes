...
class TestParseReasoningConfig(unittest.TestCase):
    ...
    def _parse(self, effort):
        from zermes.cli import _parse_reasoning_config
...
class TestReasoningPreviewBuffering(unittest.TestCase):
    ...
    @patch("zermes.cli._cprint")
    @patch("zermes.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=50))
    ...
    @patch("zermes.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=60))
