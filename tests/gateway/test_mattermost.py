...
class TestMattermostRequirements:
    def test_check_requirements_with_token_and_url(self, monkeypatch):
        ...
        monkeypatch.setenv("MATTERMOST_URL", "https://mm.example.com")
        from zermes.gateway.platforms.mattermost import check_mattermost_requirements
...
class TestMattermostMediaTypes:
    ...
    async def test_image_media_type_is_full_mime(self):
        ...
        with patch("zermes.gateway.platforms.base.cache_image_from_bytes", return_value="/tmp/photo.png"):
    ...
    async def test_audio_media_type_is_full_mime(self):
        ...
        with patch("zermes.gateway.platforms.base.cache_audio_from_bytes", return_value="/tmp/voice.ogg"), \
             patch("zermes.gateway.platforms.base.cache_image_from_bytes"), \
             patch("zermes.gateway.platforms.base.cache_document_from_bytes"):
    ...
    async def test_document_media_type_is_full_mime(self):
        ...
        with patch("zermes.gateway.platforms.base.cache_document_from_bytes", return_value="/tmp/report.pdf"), \
             patch("zermes.gateway.platforms.base.cache_image_from_bytes"):
