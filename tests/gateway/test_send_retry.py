...
from zermes.gateway.platforms.base import BasePlatformAdapter, SendResult, _RETRYABLE_ERROR_PATTERNS
from zermes.gateway.platforms.base import Platform, PlatformConfig
