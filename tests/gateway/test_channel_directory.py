...
from zermes.gateway.channel_directory import (
...
class TestLoadDirectory:
    def test_missing_file(self, tmp_path):
        with patch("zermes.gateway.channel_directory.DIRECTORY_PATH", tmp_path / "nope.json"):
...
class TestResolveChannelName:
    def _setup(self, tmp_path, platforms):
        ...
        return patch("zermes.gateway.channel_directory.DIRECTORY_PATH", cache_file)
