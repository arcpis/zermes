...
from zermes.gateway.platforms.wecom_callback import WecomCallbackAdapter
from zermes.gateway.platforms.wecom_crypto import WXBizMsgCrypt
...
class TestWecomCrypto:
    ...
    def test_signature_mismatch_raises(self):
        ...
        root = ET.fromstring(encrypted_xml)
        from zermes.gateway.platforms.wecom_crypto import SignatureError
