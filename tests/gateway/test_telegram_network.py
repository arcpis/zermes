"""Tests for zermes.gateway.platforms.telegram_network – fallback transport layer.
...
from zermes.gateway.platforms import telegram_network as tnet
...
class TestConfigFallbackIps:
    def test_env_var_populates_config_extra(self, monkeypatch):
        from zermes.gateway.config import GatewayConfig, Platform, PlatformConfig, _apply_env_overrides
