...
async def test_compress_command_reports_noop_without_success_banner():
    ...
    with (
        patch("zermes.gateway.run._resolve_runtime_agent_kwargs", return_value={"api_key": "test-key"}),
        ...
        patch("zermes.agent.model_metadata.estimate_request_tokens_rough", side_effect=_estimate),
    ):
