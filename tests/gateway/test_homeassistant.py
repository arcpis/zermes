...
from zermes.gateway.platforms.homeassistant import (
...
class TestCheckRequirements:
    ...
    @patch("zermes.gateway.platforms.homeassistant.AIOHTTP_AVAILABLE", False)
...
class TestSendViaRestApi:
    ...
    async def test_send_success(self):
        ...
        with patch("zermes.gateway.platforms.homeassistant.aiohttp") as mock_aiohttp:
