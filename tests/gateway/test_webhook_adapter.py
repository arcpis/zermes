...
from zermes.gateway.platforms.webhook import (
    WebhookAdapter,
    _INSECURE_NO_AUTH,
...
class TestHTTPHandling:
    ...
    async def test_connect_starts_server(self):
        ...
        with patch("zermes.gateway.platforms.webhook.web.AppRunner") as MockRunner, \
             patch("zermes.gateway.platforms.webhook.web.TCPSite") as MockSite:
...
class TestCheckRequirements:
    ...
    @patch("zermes.gateway.platforms.webhook.AIOHTTP_AVAILABLE", False)
...
class TestInsecureNoAuthSafetyRail:
    ...
    def test_is_loopback_host_accepts(self, host):
        ...
        from zermes.gateway.platforms.webhook import _is_loopback_host
