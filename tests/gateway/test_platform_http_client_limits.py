...
def test_returns_none_when_httpx_unavailable(monkeypatch):
    ...
    import zermes.gateway.platforms._http_client_limits as mod
...
def test_helper_is_importable_from_every_platform_that_uses_it():
    ...
    import zermes.gateway.platforms.qqbot.adapter  # noqa: F401
    import zermes.gateway.platforms.wecom  # noqa: F401
    import zermes.gateway.platforms.dingtalk  # noqa: F401
    import zermes.gateway.platforms.signal  # noqa: F401
    import zermes.gateway.platforms.bluebubbles  # noqa: F401
    import zermes.gateway.platforms.wecom_callback  # noqa: F401
...
class TestWhatsappTypingLeakFix:
    ...
    def test_bare_await_removed(self):
        import inspect
        import zermes.gateway.platforms.whatsapp as mod
