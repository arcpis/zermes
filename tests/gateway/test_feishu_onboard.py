"""Tests for zermes.gateway.platforms.feishu — Feishu scan-to-create registration."""
...
class TestPostRegistration:
    ...
    @patch("zermes.gateway.platforms.feishu.urlopen")
    def test_post_registration_returns_parsed_json(self, mock_urlopen_fn):
        from zermes.gateway.platforms.feishu import _post_registration
...
class TestInitRegistration:
    ...
    def test_init_succeeds_when_client_secret_supported(self, mock_urlopen_fn):
        from zermes.gateway.platforms.feishu import _init_registration
...
class TestBeginRegistration:
    ...
    def test_begin_returns_device_code_and_qr_url(self, mock_urlopen_fn):
        from zermes.gateway.platforms.feishu import _begin_registration
...
class TestPollRegistration:
    ...
    @patch("zermes.gateway.platforms.feishu.time")
    @patch("zermes.gateway.platforms.feishu.urlopen")
    def test_poll_returns_credentials_on_success(self, mock_urlopen_fn, mock_time):
        from zermes.gateway.platforms.feishu import _poll_registration
...
class TestRenderQr:
    ...
    @patch("zermes.gateway.platforms.feishu._qrcode_mod", create=True)
    def test_render_qr_returns_true_on_success(self, mock_qrcode_mod):
        from zermes.gateway.platforms.feishu import _render_qr
    ...
    def test_render_qr_returns_false_when_qrcode_missing(self):
        ...
        with patch("zermes.gateway.platforms.feishu._qrcode_mod", None):
...
class TestProbeBot:
    ...
    def test_probe_returns_bot_info_on_success(self):
        ...
        with patch("zermes.gateway.platforms.feishu._probe_bot_sdk") as mock_sdk:
    ...
    @patch("zermes.gateway.platforms.feishu.FEISHU_AVAILABLE", False)
    @patch("zermes.gateway.platforms.feishu.urlopen")
...
class TestQrRegister:
    ...
    @patch("zermes.gateway.platforms.feishu.probe_bot")
    @patch("zermes.gateway.platforms.feishu._render_qr")
    @patch("zermes.gateway.platforms.feishu._poll_registration")
    @patch("zermes.gateway.platforms.feishu._begin_registration")
    @patch("zermes.gateway.platforms.feishu._init_registration")
