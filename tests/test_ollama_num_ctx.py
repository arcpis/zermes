...
Covers:
  ...
  zermes.run_agent.py — _ollama_num_ctx detection + extra_body injection
"""
...
from zermes.agent.model_metadata import query_ollama_num_ctx
...
class TestQueryOllamaNumCtx:
    ...
    def test_returns_none_on_connection_error(self):
        ...
        with patch("zermes.agent.model_metadata.detect_local_server_type", side_effect=Exception("timeout")):
