"""Tests for zermes.agent.models_dev — models.dev registry integration."""
import json
...
class TestLookupModelsDevContext:
    @patch("zermes.agent.models_dev.fetch_models_dev")
...
class TestFetchModelsDev:
    @patch("zermes.agent.models_dev.requests.get")
    def test_fetch_success(self, mock_get):
        ...
        # Clear caches
        import zermes.agent.models_dev as md
...
class TestGetModelCapabilities:
    ...
    def test_vision_from_attachment_flag(self):
        ...
        with patch("zermes.agent.models_dev.fetch_models_dev", return_value=CAPS_REGISTRY):
