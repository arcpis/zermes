"""Tests for zermes.agent.auxiliary_client._try_custom_endpoint's anthropic_messages branch.
...
def test_custom_endpoint_anthropic_messages_builds_anthropic_wrapper():
    ...
    from zermes.agent.auxiliary_client import _try_custom_endpoint, AnthropicAuxiliaryClient

    with patch(
        "zermes.agent.auxiliary_client._resolve_custom_runtime",
        return_value=(
...
def test_custom_endpoint_anthropic_messages_falls_back_when_sdk_missing():
    ...
    from zermes.agent.auxiliary_client import _try_custom_endpoint
    ...
    from zermes.agent.auxiliary_client import AnthropicAuxiliaryClient
