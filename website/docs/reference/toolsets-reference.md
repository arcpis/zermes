...
| `code_modification` | `complete_code_task`, `start_approved_code_task`, `commit_code_task_step`, `plan_code_task_verification`, `run_code_task_verification`, `record_code_task_safety_review`, `finalize_code_task_branch`, `get_code_task_status`, `self_evolution_thinking`, `self_update_application` | Governed self-evolution workflow: approval planning, approved execution records, verification, final reports, advisory thinking, repository-local analysis context, and audited update application state. |
