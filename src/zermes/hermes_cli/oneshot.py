...
Bypasses zermes.cli.py entirely.  No banner, no spinner, no session_id line,
...
def _validate_explicit_toolsets(toolsets: object = None) -> tuple[list[str] | None, str | None]:
    ...
    if not valid:
        return None, "hermes -z: --toolsets did not contain any valid zermes.toolsets.\n"
...
def run_oneshot(
    ...
    Args:
        ...
        provider: Optional provider override. Falls back to
            ...
            then "auto".
        toolsets: Optional comma-separated string or iterable of zermes.toolsets.
...
def _run_agent(
    ...
    from zermes.hermes_cli.models import detect_provider_for_model
    ...
    if effective_provider is None and (model or env_model):
        ...
        if explicit_model:
            ...
            try:
                from zermes.hermes_cli import model_switch as _ms
