...
from zermes.hermes_cli.config import get_project_root, get_hermes_home, get_env_path
...
from zermes.hermes_cli.models import _HERMES_USER_AGENT
from zermes.hermes_cli.vercel_auth import describe_vercel_auth
from zermes.hermes_constants import OPENROUTER_MODELS_URL
from zermes.utils import base_url_host_matches
...
from zermes.hermes_constants import is_termux as _is_termux
...
def _build_apikey_providers_list() -> list:
    ...
    _static = [
        ...
        ("Vercel AI Gateway", ("AI_GATEWAY_API_KEY",),                       "https://ai-zermes.gateway.vercel.sh/v1/models", "AI_GATEWAY_BASE_URL", True),
    ...
    try:
        ...
        from zermes.providers.base import ProviderProfile as _PP
...
def run_doctor(args):
    ...
    if config_path.exists():
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                from zermes.hermes_cli.config import get_compatible_custom_providers as _compatible_custom_providers
            ...
            if runtime_provider and runtime_provider not in ("auto", "custom", "openrouter"):
                try:
                    from zermes.hermes_cli.auth import PROVIDER_REGISTRY, get_auth_status
    ...
    if config_path.exists():
        try:
            from zermes.hermes_cli.config import check_config_version, migrate_config
        ...
        if _key:
            ...
            try:
                ...
                if _base and _base.rstrip("/").endswith("/anthropic"):
                    from zermes.agent.auxiliary_client import _to_openai_base_url
    ...
    try:
        from zermes.agent.bedrock_adapter import has_aws_credentials, resolve_aws_auth_env_var, resolve_bedrock_region
    ...
    try:
        ...
        from zermes.model_tools import check_tool_availability, TOOLSET_REQUIREMENTS
    ...
    if not _active_memory_provider:
        ...
        try:
            from zermes.plugins.memory.honcho.client import HonchoClientConfig, resolve_config_path
            ...
            if not _honcho_cfg_path.exists():
                ...
                from zermes.plugins.memory.honcho.client import get_honcho_client, reset_honcho_client
                reset_honcho_client()
                try:
        ...
        try:
            from zermes.plugins.memory.mem0 import _load_config as _load_mem0_config
    ...
    # =========================================================================
    try:
        from zermes.hermes_cli.profiles import list_profiles, _get_wrapper_dir, profile_exists
        import re as _re
