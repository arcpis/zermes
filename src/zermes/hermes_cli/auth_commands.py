...
def _provider_base_url(provider: str) -> str:
    ...
    if provider.startswith(CUSTOM_POOL_PREFIX):
        from zermes.agent.credential_pool import _get_custom_provider_config
...
def auth_add_command(args) -> None:
    ...
    if provider == "anthropic":
        from zermes.agent import anthropic_adapter as anthropic_mod
    ...
    if provider == "nous":
        ...
        # helper embeds this into zermes.providers.nous so that label_from_token
    ...
    if provider == "google-gemini-cli":
        from zermes.agent.google_oauth import run_gemini_oauth_login_pure
    ...
    if provider == "minimax-oauth":
        from zermes.hermes_cli.auth import resolve_minimax_oauth_runtime_credentials
...
def auth_remove_command(args) -> None:
    ...
    # has a RemovalStep registered in zermes.agent.credential_sources.  The step
    ...
    from zermes.hermes_cli.auth import suppress_credential_source
