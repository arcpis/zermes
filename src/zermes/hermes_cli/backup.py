...
from zermes.hermes_constants import get_default_hermes_root, get_hermes_home, display_hermes_home
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if profiles_dir.is_dir():
            try:
                ...
                # zermes.hermes_cli.profiles might not be available (fresh install)
