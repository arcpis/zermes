...
from zermes.hermes_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _redact(value: str) -> str:
    ...
    Thin wrapper over :func:`zermes.agent.redact.mask_secret`. Returns ``""`` for
...
def _gateway_status() -> str:
    ...
    try:
        from zermes.hermes_cli.gateway import get_gateway_runtime_snapshot
