...
Usage examples::
    ...
    hermes logs                    # last 50 lines of zermes.agent.log
    hermes logs -f                 # follow zermes.agent.log in real time
    hermes logs errors             # last 50 lines of errors.log
    hermes logs gateway -n 100    # last 100 lines of zermes.gateway.log
...
LOG_FILES = {
    "agent": "zermes.agent.log",
    "errors": "errors.log",
    "gateway": "zermes.gateway.log",
}
...
# Matches: "INFO zermes.gateway.run:" or "INFO [sess_abc] zermes.tools.terminal_tool:"
