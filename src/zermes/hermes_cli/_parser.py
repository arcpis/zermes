...
def _inherited_flag(parser, *args, **kwargs):
    """Register a flag that ``zermes.hermes_cli.relaunch`` should carry over when
...
Examples:
    ...
    hermes logs                   View zermes.agent.log (last 50 lines)
...
def build_top_level_parser():
    ...
    chat_parser.add_argument(
        ...
        default=None,
        metavar="N",
        help="Maximum tool-calling iterations per conversation turn (default: 90, or zermes.agent.max_turns in config)",
    )
    _inherited_flag(
        chat_parser,
        "--yolo",
