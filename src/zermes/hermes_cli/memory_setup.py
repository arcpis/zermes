"""hermes memory setup|status — configure memory provider zermes.plugins.
...
def _install_dependencies(provider_name: str) -> None:
    ...
    import subprocess
    from zermes.plugins.memory import find_provider_dir
...
def cmd_setup_provider(provider_name: str) -> None:
    ...
    if not match:
        ...
        print("  Run 'hermes memory setup' to see available zermes.providers.\n")
        return
