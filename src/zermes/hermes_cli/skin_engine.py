...
.. code-block:: python
    ...
    from zermes.hermes_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "branding": {
            "agent_name": "Zermes",
            "welcome": "Welcome to Zermes! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Zermes ",
            "prompt_symbol": "❯ ",
            "help_header": "[?] Available Commands",
        },
        "tool_prefix": "┊",
