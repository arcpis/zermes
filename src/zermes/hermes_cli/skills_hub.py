...
# zermes.tools.skills_hub and zermes.tools.skills_guard are imported inside functions.
...
def _resolve_short_name(name: str, sources, console: Console) -> str:
    ...
    """
    from zermes.tools.skills_hub import unified_search
...
def _existing_categories() -> List[str]:
    ...
    """
    from zermes.tools.skills_hub import SKILLS_DIR
    out: List[str] = []
    try:
...
def do_search(query: str, source: str = "all", limit: int = 10,
    ...
    from zermes.tools.skills_hub import GitHubAuth, create_source_router, unified_search
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    from zermes.tools.skills_guard import scan_skill, should_allow_install, format_scan_report
    ...
    try:
        ...
        from zermes.tools.skills_hub import append_audit_log
...
def do_inspect(identifier: str, console: Optional[Console] = None) -> None:
    ...
    from zermes.tools.skills_hub import GitHubAuth, create_source_router
...
def do_list(source_filter: str = "all",
    ...
    """
    from zermes.tools.skills_hub import HubLockFile, ensure_hub_dirs
    from zermes.tools.skills_sync import _read_manifest
...
def do_check(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from zermes.tools.skills_hub import check_for_skill_updates
...
def do_update(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from zermes.tools.skills_hub import HubLockFile, check_for_skill_updates
...
def do_audit(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from zermes.tools.skills_hub import HubLockFile, SKILLS_DIR
    from zermes.tools.skills_guard import scan_skill, format_scan_report
...
def do_uninstall(name: str, console: Optional[Console] = None,
    ...
    from zermes.tools.skills_hub import uninstall_skill
...
def do_reset(name: str, restore: bool = False,
    ...
    from zermes.tools.skills_sync import reset_bundled_skill
...
def do_tap(action: str, repo: str = "", console: Optional[Console] = None) -> None:
    ...
    from zermes.tools.skills_hub import TapsManager
...
def do_publish(skill_path: str, target: str = "github", repo: str = "",
    ...
    from zermes.tools.skills_hub import GitHubAuth, SKILLS_DIR
    from zermes.tools.skills_guard import scan_skill, format_scan_report
...
def do_snapshot_export(output_path: str, console: Optional[Console] = None) -> None:
    ...
    from zermes.tools.skills_hub import HubLockFile, TapsManager
