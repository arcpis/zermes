...
STT dispatch via zermes.tools.transcription_tools, and TTS playback via
...
def transcribe_recording(wav_path: str, model: Optional[str] = None) -> Dict[str, Any]:
    ...
    Delegates to ``zermes.tools.transcription_tools.transcribe_audio()``.
...
def check_voice_requirements() -> Dict[str, Any]:
    ...
    from zermes.tools.transcription_tools import _get_provider, _load_stt_config, is_stt_enabled
