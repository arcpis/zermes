"""Managed Modal environment backed by tool-zermes.gateway."""
...
from zermes.tools.environments.modal_utils import (
...
class ManagedModalEnvironment(BaseModalExecutionEnvironment):
    ...
    def __init__(
        ...
        self._gateway_origin = zermes.gateway.gateway_origin.rstrip("/")
        self._nous_user_token = zermes.gateway.nous_user_token
    ...
    def _guard_unsupported_credential_passthrough(self) -> None:
        ...
        try:
            from zermes.tools.credential_files import get_credential_file_mounts
        except Exception:
            return
