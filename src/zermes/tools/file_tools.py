#!/usr/bin/env python3
"""File Tools Module - LLM agent file manipulation zermes.tools."""
...
from zermes.agent.file_safety import get_read_block_error
from zermes.tools.binary_extensions import has_binary_extension
...
def _get_live_tracking_cwd(task_id: str = "default") -> str | None:
    ...
    try:
        from zermes.tools.terminal_tool import _resolve_container_task_id
    ...
    try:
        from zermes.tools.terminal_tool import _active_environments, _env_lock
...
def _get_file_ops(task_id: str = "default") -> ShellFileOperations:
    ...
    with task_lock:
        ...
        if terminal_env is None:
            from zermes.tools.terminal_tool import _task_env_overrides
...
def notify_other_tool_call(task_id: str = "default"):
    ...
    Called by the tool dispatcher (zermes.model_tools.py) whenever a tool OTHER
...
def _check_file_reqs():
    ...
    from zermes.tools import check_file_requirements
