"""Shim for tool discovery. Registers `computer_use` with zermes.tools.registry.

The real implementation lives in the `tools/computer_use/` package to keep
the file structure clean. This shim exists because zermes.tools.registry auto-imports
...
from zermes.tools.computer_use.tool import (
