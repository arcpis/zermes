...
def _submit_fal_request(model: str, arguments: Dict[str, Any]):
    """Submit a FAL request using direct credentials or the managed queue zermes.gateway."""
...
def check_image_generation_requirements() -> bool:
    ...
    # Probe plugin zermes.providers. Discovery is idempotent and cheap.
    try:
...
IMAGE_GENERATE_SCHEMA = {
    ...
    "description": (
        ...
        "selectable by the zermes.agent. Returns either a URL or an absolute file "
