...
check in ``zermes.run_agent._should_parallelize_tool_batch`` — this module catches
...
# Number of resolved-path entries retained per zermes.agent.  Bounded to keep
...
class FileStateRegistry:
    ...
    def check_stale(self, task_id: str, resolved: str) -> Optional[str]:
        ...
        # first touch by this zermes.agent.  Let existing _check_sensitive_path
        ...
        if stamp is None:
            return (
                f"{resolved} was not read by this zermes.agent. "
