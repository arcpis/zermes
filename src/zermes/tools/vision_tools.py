...
import httpx
from zermes.agent.auxiliary_client import async_call_llm, extract_content_or_reasoning
...
def _resolve_download_timeout() -> float:
    ...
    if env_val:
        try:
            ...
            pass
    try:
        from zermes.hermes_cli.config import cfg_get, load_config
        cfg = load_config()
...
async def vision_analyze_tool(
    ...
    function (typically zermes.model_tools.py) to include both full description
    ...
    try:
        ...
        # Use the prompt as provided (zermes.model_tools.py now handles full description formatting)
