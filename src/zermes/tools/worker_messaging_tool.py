#!/usr/bin/env python3
"""Worker Agent messaging tools for the main zermes.agent.
...
def _auto_complete_tasks(
    ...
    if not new_replies:
        return []
    from zermes.tools.worker_task_state import load_task_state, save_task_state
...
def _handle_send_worker_message(args: dict[str, Any]) -> str:
    ...
    try:
        from zermes.hermes_cli.worker_agents_product import (
