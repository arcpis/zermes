...
async def _redirect_handler(authorization_url: str) -> None:
    ...
    as a fallback for headless/SSH/gateway zermes.environments.
    """
    msg = (
...
# ``zermes.tools.mcp_oauth_manager.MCPOAuthManager._build_provider`` so the two
...
def build_oauth_auth(
    ...
    :func:`zermes.tools.mcp_oauth_manager.get_manager` so OAuth state is shared
