...
Wiring
------
* `tool.py`       — registers the `computer_use` tool via zermes.tools.registry.
...
# Re-export the public surface so `from zermes.tools.computer_use import ...` works.
from zermes.tools.computer_use.tool import (  # noqa: F401
    handle_computer_use,
