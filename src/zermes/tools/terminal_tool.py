...
Singularity, Daytona, and Vercel Sandbox zermes.environments. Supports local
...
# ---------------------------------------------------------------------------
from zermes.tools.interrupt import is_interrupted, _interrupt_event  # noqa: F401 — re-exported
...
from zermes.tools.environments.singularity import _get_scratch_dir
from zermes.tools.tool_backend_helpers import (
    coerce_modal_mode,
...
# the per-session queue in zermes.tools.approval, not through these callbacks,
# so it's unaffected.
import threading
...
def _transform_sudo_command(command: str | None) -> tuple[str | None, str | None]:
    ...
    consistent sudo handling across local, SSH, and container zermes.environments.
...
from zermes.tools.environments.local import LocalEnvironment as _LocalEnvironment
from zermes.tools.environments.singularity import SingularityEnvironment as _SingularityEnvironment
from zermes.tools.environments.ssh import SSHEnvironment as _SSHEnvironment
from zermes.tools.environments.docker import DockerEnvironment as _DockerEnvironment
from zermes.tools.environments.modal import ModalEnvironment as _ModalEnvironment
from zermes.tools.environments.managed_modal import ManagedModalEnvironment as _ManagedModalEnvironment
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    if env_type == "local":
        ...
        from zermes.tools.environments.daytona import DaytonaEnvironment as _DaytonaEnvironment
        ...
        from zermes.tools.environments.vercel_sandbox import (
...
def _cleanup_inactive_envs(lifetime_seconds: int = 300):
    ...
    for task_id, env in envs_to_stop:
        ...
        try:
            from zermes.tools.file_tools import clear_file_ops_cache
...
def _cleanup_thread_worker():
    """Background thread worker that periodically cleans up inactive zermes.environments."""
...
def cleanup_all_environments():
    """Clean up ALL active zermes.environments. Use with caution."""
        ...
        if background:
            ...
            try:
                ...
                if background and (notify_on_complete or watch_patterns):
                    from zermes.gateway.session_context import get_session_env as _gse
            ...
            try:
                from zermes.hermes_cli.plugins import invoke_hook
            ...
            from zermes.tools.tool_output_limits import get_max_bytes
...
def check_terminal_requirements() -> bool:
    ...
    try:
        ...
        if env_type == "local":
            ...
            from zermes.tools.environments.docker import find_docker
            docker = find_docker()
            if not docker:
