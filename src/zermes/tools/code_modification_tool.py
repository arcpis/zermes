...
from zermes.code_modification.executor import (
...
from zermes.code_modification.git_workflow import GitWorkflowError
...
from zermes.code_modification.repo_lock import (
    RepoLockError,
    acquire_repo_lock,
...
from zermes.code_modification.token_strategy import AnalysisHints, build_analysis_context
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "mode": {
                "type": "string",
                "description": (
                    "Application mode for plan: manual, cli, gateway, or zermes.cron. "
