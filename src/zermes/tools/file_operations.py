...
Usage:
    ...
    from zermes.tools.terminal_tool import _active_environments
...
from zermes.tools.binary_extensions import BINARY_EXTENSIONS

from zermes.agent.file_safety import (
...
def normalize_read_pagination(offset: Any = DEFAULT_READ_OFFSET,
    ...
    """
    from zermes.tools.tool_output_limits import get_max_lines
...
class ShellFileOperations(FileOperations):
    ...
    This includes local, docker, singularity, ssh, modal, and daytona zermes.environments.
    """
    ...
    def _add_line_numbers(self, content: str, start_line: int = 1) -> str:
        ...
        from zermes.tools.tool_output_limits import get_max_line_length
    ...
    def patch_v4a(self, patch_content: str) -> PatchResult:
        ...
        """
        # Import patch parser
        from zermes.tools.patch_parser import parse_v4a_patch, apply_v4a_operations
