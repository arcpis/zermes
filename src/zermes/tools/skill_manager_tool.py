...
from zermes.utils import atomic_replace, is_truthy_value
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    {"path": Path} or None.
    """
    from zermes.agent.skill_utils import EXCLUDED_SKILL_DIRS, get_all_skills_dirs
...
def _validate_file_path(file_path: str) -> Optional[str]:
    ...
    """
    from zermes.tools.path_security import has_traversal_component
...
def _resolve_skill_target(skill_dir: Path, file_path: str) -> Tuple[Optional[Path], Optional[str]]:
    ...
    from zermes.tools.path_security import validate_within_dir
...
def _patch_skill(
    ...
    from zermes.tools.fuzzy_match import fuzzy_find_and_replace
    ...
    if match_error:
        ...
        err_msg = match_error
        try:
            from zermes.tools.fuzzy_match import format_no_match_hint
...
def skill_manage(
    ...
    if result.get("success"):
        ...
        try:
            from zermes.tools.skill_usage import bump_patch, forget, mark_agent_created
            from zermes.tools.skill_provenance import is_background_review
            if action == "create":
