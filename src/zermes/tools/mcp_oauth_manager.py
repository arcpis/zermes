...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        extracted from ``zermes.tools.mcp_oauth``. The subclass injects a pre-flow
    ...
    def remove(self, server_name: str) -> None:
        ...
        from zermes.tools.mcp_oauth import remove_oauth_tokens
    ...
    async def invalidate_if_disk_changed(self, server_name: str) -> bool:
        ...
        """
        from zermes.tools.mcp_oauth import _get_token_dir, _safe_filename
