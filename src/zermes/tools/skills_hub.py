...
from zermes.tools.skills_guard import (
...
class OptionalSkillSource(SkillSource):
    ...
    def __init__(self):
        ...
        self._optional_dir = get_optional_skills_dir(
            Path(__file__).resolve().parents[3] / "resources" / "skills" / "optional"
        )
    ...
    def _find_skill_dir(self, name: str) -> Optional[Path]:
        """Find a skill directory by name anywhere in resources/skills/optional/."""
...
HERMES_INDEX_URL = "https://hermes-zermes.agent.nousresearch.com/docs/api/skills-index.json"
