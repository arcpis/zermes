...
This module exposes a ContextVar that zermes.run_agent.py sets before each tool
...
_spawn_background_review in zermes.run_agent.py) and defaults to "assistant_tool"
...
# zermes.run_agent.py's AIAgent._memory_write_origin override in
