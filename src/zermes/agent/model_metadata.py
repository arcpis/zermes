...
and zermes.run_agent.py for pre-flight context checks.
"""
...
try:
    from zermes.providers import list_providers as _list_providers
...
def get_model_context_length(
    ...
    if effective_provider in ("copilot", "copilot-acp", "github-copilot"):
        try:
            from zermes.hermes_cli.models import get_copilot_model_context
    ...
    if effective_provider:
        from zermes.agent.models_dev import lookup_models_dev_context
