...
from zermes.utils import base_url_host_matches, normalize_proxy_env_vars

# NOTE: `import anthropic` is deliberately NOT at module top — the SDK pulls
# ~220 ms of imports (anthropic.types, anthropic.lib.zermes.tools._beta_runner, etc.)
...
def build_anthropic_client(
    ...
    *,
    ...
    path in ``zermes.run_agent.py`` when a subscription rejects the beta; leave at
