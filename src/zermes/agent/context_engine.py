...
class ContextEngine(ABC):
    ...
    # -- Token state (read by zermes.run_agent.py for display/logging) ------------
    #
    # Engines MUST maintain these. zermes.run_agent.py reads them directly.
    ...
    # -- Compaction parameters (read by zermes.run_agent.py for preflight) --------
    #
    ...
    def get_tool_schemas(self) -> List[Dict[str, Any]]:
        """Return tool schemas this engine provides to the zermes.agent.
    ...
    def handle_tool_call(self, name: str, args: Dict[str, Any], **kwargs) -> str:
        """Handle a tool call from the zermes.agent.
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        Default returns the standard fields zermes.run_agent.py expects.
        """
        return {
