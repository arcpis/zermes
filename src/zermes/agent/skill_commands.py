...
Shared between CLI (zermes.cli.py) and gateway (gateway/run.py) so both surfaces
...
from zermes.agent.skill_preprocessing import (
...
def _load_skill_payload(skill_identifier: str, task_id: str | None = None) -> tuple[dict[str, Any], Path | None, str] | None:
    ...
    try:
        from zermes.tools.skills_tool import SKILLS_DIR, skill_view
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    ...
    _skill_commands = {}
    try:
        from zermes.tools.skills_tool import SKILLS_DIR, _parse_frontmatter, skill_matches_platform, _get_disabled_skill_names
...
def reload_skills() -> Dict[str, Any]:
    ...
    slash-command map (``zermes.agent.skill_commands._skill_commands``) reflects
