"""Abstract base class for pluggable memory zermes.providers.
...
Lifecycle (called by MemoryManager, wired in zermes.run_agent.py):
...
class MemoryProvider(ABC):
    """Abstract base class for memory zermes.providers."""
    ...
    def handle_tool_call(self, tool_name: str, args: Dict[str, Any], **kwargs) -> str:
        """Handle a tool call for one of this provider's zermes.tools.
