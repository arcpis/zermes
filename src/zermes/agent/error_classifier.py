...
that the main retry loop in zermes.run_agent.py consults for every API failure.
"""
...
def classify_api_error(
    ...
    *,
    ...
    # in zermes.run_agent.py rebuilds the Anthropic client with the beta stripped
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # the retryability check in zermes.run_agent.py.  If those succeed, the
