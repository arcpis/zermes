...
from zermes.hermes_constants import get_hermes_home, get_skills_dir, is_wsl
...
DEFAULT_AGENT_IDENTITY = (
    ...
    "analyzing information, creative work, and executing actions via your zermes.tools. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    ...
    "before answering. Docs: https://hermes-zermes.agent.nousresearch.com/docs\n"
...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Ask a clarifying question only when the information cannot be retrieved by zermes.tools.\n"
...
# ---------------------------------------------------------------------------
# Environment hints — execution-environment awareness for the zermes.agent.
...
def _probe_remote_backend(env_type: str) -> str | None:
    ...
    try:
        ...
        from zermes.tools.terminal_tool import _get_env_config  # type: ignore
        from zermes.tools.environments import get_environment  # type: ignore
...
def build_worker_task_state_prompt() -> str:
    ...
    """
    try:
        from zermes.tools.worker_task_state import get_pending_tasks
    except Exception:
        return ""
