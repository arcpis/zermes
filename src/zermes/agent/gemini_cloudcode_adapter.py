...
- ``GeminiCloudCodeClient`` exposes ``.chat.completions.create(**kwargs)``
  mirroring the subset of the OpenAI SDK that ``zermes.run_agent.py`` uses.
...
from zermes.agent.gemini_schema import sanitize_gemini_tool_parameters
from zermes.agent.google_code_assist import (
...
class GeminiCloudCodeClient:
    ...
    def __init__(
        ...
        **_: Any,
        ...
        # fetched on every call via zermes.agent.google_oauth.get_valid_access_token().
