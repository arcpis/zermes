...
The Code Assist API powers Google's official gemini-zermes.cli. It sits at
...
class CodeAssistError(RuntimeError):
    ...
    def __init__(
        ...
        *,
        ...
        self.code = code
        # ``status_code`` is picked up by ``zermes.agent.error_classifier._extract_status_code``
