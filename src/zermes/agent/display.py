...
from zermes.utils import safe_json_loads
...
def _resolve_skill_manage_paths(args: dict) -> list[Path]:
    ...
    from zermes.tools.skill_manager_tool import _find_skill, _resolve_skill_dir
...
def _resolve_local_edit_paths(tool_name: str, function_args: dict | None) -> list[Path]:
    """Resolve local filesystem targets for write-capable zermes.tools."""
