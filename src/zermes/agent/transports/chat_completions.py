...
from zermes.agent.moonshot_schema import is_moonshot_model, sanitize_moonshot_tools
from zermes.agent.prompt_builder import DEVELOPER_ROLE_MODELS
from zermes.agent.transports.base import ProviderTransport
from zermes.agent.transports.types import NormalizedResponse, ToolCall, Usage
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    The default path for OpenAI-compatible zermes.providers.
    """
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        """
        from zermes.providers.base import OMIT_TEMPERATURE
...
from zermes.agent.transports import register_transport  # noqa: E402
