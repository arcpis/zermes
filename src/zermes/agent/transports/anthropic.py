...
class AnthropicTransport(ProviderTransport):
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from zermes.agent.anthropic_adapter import convert_tools_to_anthropic
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        """
        import json
        from zermes.agent.anthropic_adapter import _to_plain_data
        from zermes.agent.transports.types import ToolCall
