...
def apply_automatic_transitions(now: Optional[datetime] = None) -> Dict[str, int]:
    ...
    from zermes.tools import skill_usage as _u
...
def _reports_root() -> Path:
    ...
    alongside ``zermes.agent.log`` and ``zermes.gateway.log`` so it's found by anyone
    ...
    *,
    ...
    try:
        ...
        if consolidated_map or pruned_names:
            from zermes.cron.jobs import rewrite_skill_refs as _rewrite_cron_refs
