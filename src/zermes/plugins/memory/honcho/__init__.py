...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        import types
        from zermes.plugins.memory.honcho.cli import cmd_setup
    ...
    def _do_session_init(self, cfg, session_id: str, **kwargs) -> None:
        ...
        from zermes.plugins.memory.honcho.client import get_honcho_client
        from zermes.plugins.memory.honcho.session import HonchoSessionManager
    ...
    def get_tool_schemas(self) -> List[Dict[str, Any]]:
        ...
        B1: context-only mode hides all zermes.tools.
        """
        if self._cron_skipped:
            return []
        if self._recall_mode == "context":
