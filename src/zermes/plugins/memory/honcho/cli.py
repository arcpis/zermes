...
from zermes.plugins.memory.honcho.client import resolve_active_host, resolve_config_path, HOST
...
def _ensure_peer_exists(host_key: str | None = None) -> bool:
    ...
    """
    try:
        from zermes.plugins.memory.honcho.client import HonchoClientConfig, get_honcho_client
...
def cmd_setup(args) -> None:
    ...
    try:
        from zermes.plugins.memory.honcho.client import HonchoClientConfig, get_honcho_client, reset_honcho_client
        reset_honcho_client()
...
def honcho_command(args) -> None:
    ...
    if sub == "setup":
        ...
        from zermes.hermes_cli.memory_setup import cmd_setup_provider
