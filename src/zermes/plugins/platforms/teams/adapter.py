...
class TeamsSummaryWriter:
    ...
    def _build_graph_client(self, config: dict[str, Any]) -> Any:
        ...
        from zermes.tools.microsoft_graph_auth import MicrosoftGraphTokenProvider
        from zermes.tools.microsoft_graph_client import MicrosoftGraphClient
...
class TeamsAdapter(BasePlatformAdapter):
    ...
    async def _on_message(self, ctx: ActivityContext[MessageActivity]) -> None:
        """Process an incoming Teams message and dispatch to the zermes.gateway."""
    ...
    async def _on_card_action(
        ...
        from zermes.tools.approval import resolve_gateway_approval, has_blocking_approval
