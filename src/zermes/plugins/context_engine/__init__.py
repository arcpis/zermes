...
zermes.plugins.  Each subdirectory must contain ``__init__.py`` with a class
...
Usage:
    from zermes.plugins.context_engine import discover_context_engines, load_context_engine
...
def _load_engine_from_dir(engine_dir: Path) -> Optional["ContextEngine"]:
    ...
    module_name = f"zermes.plugins.context_engine.{name}"
    ...
    if module_name in sys.modules:
        ...
        for parent in ("plugins", "zermes.plugins.context_engine"):
