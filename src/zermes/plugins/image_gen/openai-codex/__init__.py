...
from zermes.agent.image_gen_provider import (
...
def _read_codex_access_token() -> Optional[str]:
    ...
    Delegates to the canonical reader in ``zermes.agent.auxiliary_client`` so token
    expiry, credential pool selection, and JWT decoding stay in one place.
    """
    try:
        from zermes.agent.auxiliary_client import _read_codex_access_token as _reader
