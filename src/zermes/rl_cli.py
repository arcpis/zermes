...
Usage:
    python zermes.rl_cli.py "Train a model on GSM8k for math reasoning"
    python zermes.rl_cli.py --interactive
    python zermes.rl_cli.py --list-environments
...
from zermes.tools.rl_training_tool import get_missing_keys
...
def list_environments_sync():
    ...
    from zermes.tools.rl_training_tool import rl_list_environments
    import json
...
def main(
    ...
    Examples:
        ...
        python zermes.rl_cli.py "Train a model on GSM8k math problems"
        ...
        # Check server status
        python zermes.rl_cli.py --check-server
    """
    ...
    if not task and not interactive:
        ...
        print("\nExamples:")
        print('  python zermes.rl_cli.py "Train a model on GSM8k math problems"')
        print('  python zermes.rl_cli.py "Create an RL environment for code generation"')
        print('  python zermes.rl_cli.py --interactive')
        return
        ...
        while True:
            try:
                ...
                if user_input.lower() == 'status':
                    # Quick status check
                    from zermes.tools.rl_training_tool import rl_list_runs
                    import json
