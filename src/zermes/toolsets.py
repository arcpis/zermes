...
This module provides a flexible system for defining and managing tool aliases/zermes.toolsets.
Toolsets allow you to group tools together for specific scenarios and can be composed
from individual tools or other zermes.toolsets.
...
Usage:
    from zermes.toolsets import get_toolset, resolve_toolset, get_all_toolsets
...
# Shared tool list for CLI and all messaging platform zermes.toolsets.
...
_HERMES_CORE_TOOLS = [
    ...
    "self_evolution_repo_lock", "self_update_application",
    # Cronjob management
    "cronjob",
...
TOOLSETS = {
    ...
    "hermes-yuanbao": {
        ...
        "module": "zermes.tools.yuanbao_tools",
        "includes": []
    },
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    included toolsets and combining all zermes.tools.
...
def resolve_multiple_toolsets(toolset_names: List[str]) -> List[str]:
    """
    Resolve multiple toolsets and combine their zermes.tools.
...
def get_toolset_info(name: str) -> Dict[str, Any]:
    """
    Get detailed information about a toolset including resolved zermes.tools.
