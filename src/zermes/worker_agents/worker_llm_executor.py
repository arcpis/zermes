...
Reuses HermesAgentLoop from zermes.environments.agent_loop as the multi-turn
...
class _WorkerAsyncServer:
    ...
    ``zermes.environments.agent_loop.HermesAgentLoop``.
    """
...
class WorkerLLMExecutor:
    ...
    Uses ``HermesAgentLoop`` from ``zermes.environments.agent_loop`` as the
    ...
    def _resolve_main_agent_model(self) -> str:
        try:
            from zermes.hermes_cli.runtime_provider import _get_model_config
