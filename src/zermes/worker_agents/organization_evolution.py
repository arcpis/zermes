...
class ChildAgentRuntimeKind(StrEnum):
    """Runtime identity for a proposed durable child zermes.agent."""
...
class ChildAgentPrivateAssetDisposition(StrEnum):
    """Permitted private asset disposition for a removed durable child zermes.agent."""
...
class ChildAgentBudgetPolicy:
    """Explicit finite budget limits for a proposed durable child zermes.agent."""
...
class ChildAgentModelPolicy:
    """Explicit model allow-list for a proposed durable child zermes.agent."""
...
class DepartmentContractionPlan:
    """Plan for parent/child department shape after deleting a child zermes.agent.
