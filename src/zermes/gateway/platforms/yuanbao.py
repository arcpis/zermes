...
from zermes.gateway.platforms.yuanbao_media import (
...
from zermes.gateway.platforms.yuanbao_proto import (
    CMD_TYPE,
    _fields_to_dict,
    _get_string,
    _get_varint,
...
class GroupAtGuardMiddleware(InboundMiddleware):
    ...
    def _observe_group_message(
        ...
        *, msg_id: Optional[str] = None,
        ...
        """Write a group message into the session transcript without triggering the zermes.agent.
...
class StickerHandler(MediaSendHandler):
    ...
    def build_msg_body(self, upload_result, **kwargs):
        from zermes.gateway.platforms.yuanbao_sticker import (
            get_sticker_by_name,
            get_random_sticker,
            build_face_msg_body,
...
class GroupQueryService:
    ...
    async def query_group_info_raw(self, group_code: str) -> Optional[dict]:
        ...
        from zermes.gateway.platforms.yuanbao_proto import decode_conn_msg as _decode
