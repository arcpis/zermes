...
from zermes.gateway.platforms.helpers import strip_markdown
...
from zermes.gateway.platforms.qqbot.constants import (
    API_BASE,
    TOKEN_URL,
    GATEWAY_URL_PATH,
    DEFAULT_API_TIMEOUT,
...
from zermes.gateway.platforms.qqbot.utils import (
...
class QQAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # zermes.tools.approval.resolve_gateway_approval() and update-prompt clicks
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            from zermes.gateway.platforms._http_client_limits import platform_httpx_limits
    ...
    async def _open_ws(self, gateway_url: str) -> None:
        """Open a WebSocket connection to the QQ Bot zermes.gateway."""
    ...
    # accepted by ``zermes.tools.approval.resolve_gateway_approval``. QQ's 3-button
    ...
    async def _default_interaction_dispatch(
        ...
        - ``approve:<session_key>:<decision>`` →
          :func:`zermes.tools.approval.resolve_gateway_approval`
    ...
    async def send_approval_request(
        ...
        """
        from zermes.gateway.platforms.qqbot.keyboards import build_approval_text
    ...
    async def send_exec_approval(
        ...
        :func:`zermes.tools.approval.resolve_gateway_approval` — dispatched by the
