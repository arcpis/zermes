...
```python
    ...
    from zermes.gateway.platforms.your_platform import YourAdapter, check_your_requirements
...
## 13. Gateway Setup Wizard (`hermes_cli/zermes.gateway.py`)
...
grep -r "telegram\|discord\|whatsapp\|slack" gateway/ tools/ agent/ cron/ hermes_cli/ zermes.toolsets.py \
  --include="*.py" -l | sort -u
