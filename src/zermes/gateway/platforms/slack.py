...
from zermes.gateway.platforms.helpers import MessageDeduplicator
...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            from zermes.hermes_cli.commands import slack_native_slashes
            import re as _re
    ...
    async def send(
        ...
        try:
            ...
            # Controlled via platform config: zermes.gateway.slack.reply_broadcast
    ...
    async def send_multiple_images(
        ...
        try:
            ...
            from zermes.tools.url_safety import is_safe_url as _is_safe_url
        except Exception:
    ...
    async def _handle_slack_message(self, event: dict) -> None:
        ...
        for f in files:
            ...
            if mimetype.startswith("image/") and url:
                ...
                try:
                    ...
                    # snippets like JSON/YAML/configs are actually visible to the zermes.agent.
        ...
        from zermes.gateway.platforms.base import resolve_channel_prompt, resolve_channel_skills
        ...
        # Mirrors the Telegram/Discord implementations so that zermes.gateway.run
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in ("hermes", ""):
            ...
            from zermes.hermes_cli.commands import slack_subcommand_map
        ...
        async with httpx.AsyncClient(timeout=30.0, follow_redirects=True) as client:
            for attempt in range(3):
                try:
                    ...
                    # don't cache bogus data and confuse downstream zermes.tools.
                    ct = response.headers.get("content-type", "")
                    if "text/html" in ct:
                        raise ValueError(
                    ...
                    if audio:
                        from zermes.gateway.platforms.base import cache_audio_from_bytes
