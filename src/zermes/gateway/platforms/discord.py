...
from zermes.gateway.platforms.helpers import MessageDeduplicator, ThreadParticipationTracker
...
from zermes.tools.url_safety import is_safe_url
...
def _clean_discord_id(entry: str) -> str:
    ...
    or ``<@!123>`` from Discord's UI or other zermes.tools.  This normalises the
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            from zermes.gateway.platforms.base import resolve_proxy_url, proxy_kwargs_for_bot
    ...
    async def _send_to_forum(self, forum_channel: Any, content: str) -> SendResult:
        ...
        partial-send issues.
        """
        from zermes.tools.send_message_tool import _derive_forum_thread_name
    ...
    def _is_allowed_user(
        ...
        *,
        ...
        # (see AGENTS.md pitfall #17 — same pattern as zermes.gateway.run).
    ...
    def _register_slash_commands(self) -> None:
        ...
        try:
            from zermes.hermes_cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from zermes.hermes_cli.commands import _iter_plugin_command_entries
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from zermes.hermes_cli.commands import discord_skill_commands_by_category
    ...
    def refresh_skill_group(self) -> tuple[int, int]:
        ...
        Invoked by :meth:`zermes.gateway.run.GatewayOrchestrator._handle_reload_skills_command`
        after :func:`zermes.agent.skill_commands.reload_skills` has refreshed
    ...
    def _resolve_channel_skills(self, channel_id: str, parent_id: str | None = None) -> list[str] | None:
        ...
        """
        from zermes.gateway.platforms.base import resolve_channel_skills
        return resolve_channel_skills(self.config.extra, channel_id, parent_id)

    def _resolve_channel_prompt(self, channel_id: str, parent_id: str | None = None) -> str | None:
        """Resolve a Discord per-channel prompt, preferring the exact channel over its parent."""
        from zermes.gateway.platforms.base import resolve_channel_prompt
