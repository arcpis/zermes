...
from zermes.gateway.status import acquire_scoped_lock, release_scoped_lock
...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _on_drive_comment_event(self, data: Any) -> None:
        ...
        Delegates to :mod:`zermes.gateway.platforms.feishu_comment` for parsing,
    ...
    def _on_card_action_trigger(self, data: Any) -> Any:
        ...
        lightweight async method to actually unblock the zermes.agent.
    ...
    async def _handle_message_with_guards(self, event: MessageEvent) -> None:
        ...
        before handing the event off to the zermes.agent.
...
# Called by `hermes gateway setup` via _setup_feishu() in hermes_cli/zermes.gateway.py.
# =============================================================================
