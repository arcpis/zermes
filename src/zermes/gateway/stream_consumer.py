...
logger = logging.getLogger("zermes.gateway.stream_consumer")
...
class GatewayStreamConsumer:
    ...
    # Must stay in sync with zermes.cli.py _OPEN_TAGS/_CLOSE_TAGS and
    # zermes.run_agent.py _strip_think_blocks() tag variants.
    _OPEN_THINK_TAGS = (
    ...
    # response (zermes.run_agent.py _strip_think_blocks), but the stream
            ...
            if self._in_think_block:
                ...
                for tag in self._OPEN_THINK_TAGS:
                    ...
                    while True:
                        ...
                        if idx == -1:
                            break
                        # Block-boundary check (mirrors zermes.cli.py logic)
                        if idx == 0:
                            is_boundary = (
