...
The PID file lives at ``{HERMES_HOME}/zermes.gateway.pid``.  HERMES_HOME defaults to
...
_UNSET = object()
_GATEWAY_LOCK_FILENAME = "zermes.gateway.lock"
...
def _get_pid_path() -> Path:
    ...
    return home / "zermes.gateway.pid"
...
def _looks_like_gateway_process(pid: int) -> bool:
    """Return True when the live PID still looks like the Hermes zermes.gateway."""
...
def acquire_gateway_runtime_lock() -> bool:
    """Claim the cross-process runtime lock for the zermes.gateway.
