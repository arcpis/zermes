"""
Session management for the zermes.gateway.
...
from .whatsapp_identity import (
    ...
    normalize_whatsapp_identifier,  # noqa: F401 - re-exported for zermes.gateway.session callers
)
...
def build_session_context_prompt(
    ...
    *,
    ...
    # each user message by the zermes.gateway.
