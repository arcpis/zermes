...
# `from model_tools import ...` and `from zermes.environments.X import ...` work
...
from zermes.environments.patches import apply_patches
apply_patches()
...
from zermes.environments.tool_context import ToolContext
from zermes.tools.budget_config import (
...
from zermes.toolset_distributions import sample_toolsets_from_distribution
...
class HermesAgentEnvConfig(BaseEnvConfig):
    """
    Configuration for hermes-agent Atropos zermes.environments.
    ...
    distribution: Optional[str] = Field(
        default=None,
        description="Name of a toolset distribution from zermes.toolset_distributions.py "
    ...
    system_prompt: Optional[str] = Field(
        default=None,
        description="System prompt for the zermes.agent. Tools are handled via the tools= parameter, "
    ...
    # --- Tool result budget ---
    # Defaults imported from zermes.tools.budget_config (single source of truth).
    ...
    def build_budget_config(self):
        ...
        from zermes.tools.budget_config import BudgetConfig
        return BudgetConfig(
...
class HermesAgentBaseEnv(BaseEnv):
    ...
    def __init__(
        ...
        from zermes.environments.agent_loop import resize_tool_pool
    ...
    def format_prompt(self, item: Item) -> str:
        """
        Convert a dataset item into the user message for the zermes.agent.
