...
Enables only terminal + file zermes.toolsets. Uses Modal terminal backend with
...
class TerminalTestEnv(HermesAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        env_config = TerminalTestEnvConfig(
            ...
            system_prompt=(
                "You are a helpful assistant with access to a terminal and file zermes.tools. "
                "Complete the user's request by using the available zermes.tools. "
