...
from zermes.environments.hermes_base_env import HermesAgentBaseEnv, HermesAgentEnvConfig
from zermes.environments.agent_loop import AgentResult
...
class WebResearchEnv(HermesAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[WebResearchEnvConfig, List[APIServerConfig]]:
        ...
        env_config = WebResearchEnvConfig(
            ...
            system_prompt=(
                "You are a highly capable research zermes.agent. When asked a factual question, "
    ...
    async def evaluate(self, *args, **kwargs) -> None:
        """Run evaluation on the held-out split using the full agent loop with zermes.tools.
        ...
        import time
        import uuid
        from zermes.environments.agent_loop import HermesAgentLoop
        from zermes.environments.tool_context import ToolContext
