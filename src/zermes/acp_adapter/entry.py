...
Usage::
    ...
    python -m zermes.acp_adapter.entry
    # or
    hermes acp
    # or
    hermes-acp
...
def main() -> None:
    """Entry point: load env, configure logging, run the ACP zermes.agent."""
    _setup_logging()
    _load_env()
    ...
    # loop; that path is unaffected.)  Moved from zermes.model_tools.py module
